...
//   public void dump(Semant.Print printer, int d) {
//     java.util.Enumeration e = dict.keys();
...
//         // print entry using your Semant.Print
//         if (val instanceof Semant.Entry) {
//             printer.prEntry((Semant.Entry) val, d + 2);
//         } else {
//             System.out.print(": <unknown entry type>");
//         }
